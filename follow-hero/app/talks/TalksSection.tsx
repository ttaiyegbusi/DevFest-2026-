...
export function TalksSection() {
  ...
  return (
    <section className="talks" ref={sectionRef}>
      <p className="talks__eyebrow">Talks</p>
      <h2 className="talks__title">
        Different talks from
        <br />
        different industry.
      </h2>
      <p className="talks__lede">
      ...
      <div
        className={`talks__pit${reduced ? " is-static" : ""}`}
        ref={pitRef}
        aria-hidden="true"
      >
        {PILLS.map((p, i) => (
